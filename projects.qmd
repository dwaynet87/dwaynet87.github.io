...
This ongoing project aims to develop a prediction model to estimate a patient’s risk of unfavorable pain outcomes after endometriosis surgery, before the surgery is performed. The goal is to facilitate the decision-making discussion between patients and clinicians. For this work, **I am employing machine learning algorithms, including the exploration of neural networks, to model the complex relationship between preoperative factors in endometriosis patients and their pain outcomes**.  The model will be presented using the **R shiny** platform and will be made available once published. The project utilizes prospectively collected clinical data from the [Endometriosis Pelvic Pain Interdisciplinary Cohort (EPPIC)](https://yonglab.med.ubc.ca/eppic/).
...
\ Sreya M, **Tucker DR**, Yi J, Alotaibi FT, Lee AF, Noga H, Yong, PJ.2024;14(5):583.
&nbsp;

<img src="nerve_density_image.jpg" style="width:45%; margin-right: 20px" align="left">
